...
--
-- Distinct from 'JustCI.Justfile.Os' — that's just's host-OS-gate
...
-- by extending this type and mirroring the @JUSTCI_JUST_DRV_*@ entry in
-- the flake.
data Platform
  = X86_64Linux
  | Aarch64Linux
...
-- else — callers (host-config loader, 'JustCI.Node.parseNodeId') tolerate
