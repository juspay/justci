...
-- on-disk log-path construction in 'JustCI.LogPath' where the platform
...
-- ('JustCI.ProcessCompose.Events.subscribeStates') hands us a raw 'Text'
...
-- 'JustCI.Pipeline.withParsedNode'): an unknown wire name means the run
...
-- consumer of 'Display'.
--
-- Lives here (rather than in "JustCI.ProcessCompose") because the
