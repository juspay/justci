...
-- @gh repo view@ and threaded into 'JustCI.CommitStatus.postConsumer'
-- alongside the 'JustCI.Git.Sha'.
...
-- @gh repo view --json defaultBranchRef@. Used by "JustCI.Pipeline.runProtect"
