...
-- @ProcessState@/@ProcessStatus@) lives in "JustCI.ProcessCompose.Events" —
-- those wire vocabularies change on a different axis from the YAML
-- config.
module JustCI.ProcessCompose
...
-- of "JustCI.Verdict", not of process-compose's own exit code.
...
-- both the 'JustCI.ProcessCompose.Events.subscribeStates' attachment point
