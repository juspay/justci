...
-- | Tests for "JustCI.Platform"'s 'Display' / 'parsePlatform' surface
...
module JustCI.PlatformSpec (spec) where

import Data.Text.Display (display)
import qualified JustCI.Justfile as J
import JustCI.Platform (Platform (..), allPlatforms, osToPlatforms, parsePlatform, platformOs)
import Test.Hspec
